      ...
      <section className="bg-[#151515] text-white py-20 relative overflow-hidden border-b border-white/10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-4">
          ...
          <motion.h1
            ...
            className="font-serif text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white"
          >
            All Surgical &{" "}
          ...
          <motion.p
            ...
            className="text-white/75 max-w-2xl mx-auto text-sm sm:text-base font-light leading-relaxed"
          >
            Explore our complete suite of board-certified plastic surgery, body contouring, facial rejuvenation, and advanced aesthetic clinical treatments.
          </motion.p>
