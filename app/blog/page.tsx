        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {posts.map((post) => (
            ...
            >
              <div>
                ...
                <div className="p-6 sm:p-8 space-y-4">
                  ...
                  <Link href={`/blog/${post.slug}`} className="block">
                    <h2 className="font-serif text-2xl font-bold text-[#151515] group-hover:text-[#E6663A] transition-colors leading-snug">
                      {post.title}
                    </h2>
                  </Link>
              ...
              <div className="p-6 sm:p-8 pt-0 flex items-center justify-between border-t border-[#EFE8E0] mt-4">
                <span className="text-xs font-semibold text-[#151515] max-w-[200px] truncate">
                  By {post.author}
                </span>
                <Link
                  href={`/blog/${post.slug}`}
